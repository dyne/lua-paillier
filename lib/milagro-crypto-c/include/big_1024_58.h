...
#ifndef BIG_1024_58_H
#define BIG_1024_58_H
...
#define BIGBITS_1024_58 (8*MODBYTES_1024_58) /**< Length in bits */
#define NLEN_1024_58 (1+((8*MODBYTES_1024_58-1)/BASEBITS_1024_58)) /**< length in bytes */
#define DNLEN_1024_58 2*NLEN_1024_58 /**< Double length in bytes */
#define BMASK_1024_58 (((chunk)1<<BASEBITS_1024_58)-1) /**< Mask = 2^BASEBITS-1 */
#define NEXCESS_1024_58 (1<<(CHUNK-BASEBITS_1024_58-1))           /**< 2^(CHUNK-BASEBITS-1) - digit cannot be multiplied by more than this before normalisation */

#define HBITS_1024_58 (BASEBITS_1024_58/2)      /**< Number of bits in number base divided by 2 */
#define HMASK_1024_58 (((chunk)1<<HBITS_1024_58)-1)    /**< Mask = 2^HBITS-1 */

//#define DEBUG_NORM

#ifdef DEBUG_NORM  /* Add an extra location to track chunk extension */
#define MPV_1024_58 NLEN_1024_58
#define MNV_1024_58 (NLEN_1024_58+1)
typedef chunk BIG_1024_58[NLEN_1024_58+2];   /**< Define type BIG as array of chunks */
#define DMPV_1024_58 DNLEN_1024_58
#define DMNV_1024_58 (DNLEN_1024_58+1)
typedef chunk DBIG_1024_58[DNLEN_1024_58+2]; /**< Define type DBIG as array of chunks */
#else
typedef chunk BIG_1024_58[NLEN_1024_58];     /**< Define type BIG as array of chunks */
typedef chunk DBIG_1024_58[DNLEN_1024_58];   /**< Define type DBIG as array of chunks */
#endif
 ...
 */
extern int BIG_1024_58_iszilch(BIG_1024_58 x);
/**	@brief Tests for BIG equal to one
 *
	@param x a BIG number
	@return 1 if one, else returns 0
 */
extern int BIG_1024_58_isunity(BIG_1024_58 x);
/**	@brief Tests for DBIG equal to zero
 *
	@param x a DBIG number
	@return 1 if zero, else returns 0
 */
extern int BIG_1024_58_diszilch(DBIG_1024_58 x);
/**	@brief Outputs a BIG number to the console
 *
	@param x a BIG number
 */
extern void BIG_1024_58_output(BIG_1024_58 x);
/**	@brief Outputs a BIG number to the console in raw form (for debugging)
 *
	@param x a BIG number
 */
extern void BIG_1024_58_rawoutput(BIG_1024_58 x);
 ...
 */
extern void BIG_1024_58_cswap(BIG_1024_58 x,BIG_1024_58 y,int s);
 ...
 */
extern void BIG_1024_58_cmove(BIG_1024_58 x,BIG_1024_58 y,int s);
 ...
 *
	...
	@param s copy takes place if not equal to 0
 */
extern void BIG_1024_58_dcmove(BIG_1024_58 x,BIG_1024_58 y,int s);
/**	@brief Convert from BIG number to byte array
 *
	@param a byte array
	@param x BIG number
 */
extern void BIG_1024_58_toBytes(char *a,BIG_1024_58 x);
/**	@brief Convert to BIG number from byte array
 *
	@param x BIG number
	@param a byte array
 */
extern void BIG_1024_58_fromBytes(BIG_1024_58 x,char *a);
 ...
 */
extern void BIG_1024_58_fromBytesLen(BIG_1024_58 x,char *a,int s);
 ...
 *
   ...
   @param s byte array length
 */
extern void BIG_1024_58_dfromBytesLen(DBIG_1024_58 x,char *a,int s);
/**	@brief Outputs a DBIG number to the console
 *
	@param x a DBIG number
 */
extern void BIG_1024_58_doutput(DBIG_1024_58 x);

/**	@brief Outputs a DBIG number to the console
 *
	@param x a DBIG number
 */
extern void BIG_1024_58_drawoutput(DBIG_1024_58 x);
 ...
 */
extern void BIG_1024_58_rcopy(BIG_1024_58 x,const BIG_1024_58 y);
/**	@brief Copy BIG to another BIG
 *
	@param x BIG number
	@param y BIG number to be copied
 */
extern void BIG_1024_58_copy(BIG_1024_58 x,BIG_1024_58 y);
/**	@brief Copy DBIG to another DBIG
 *
	@param x DBIG number
	@param y DBIG number to be copied
 */
extern void BIG_1024_58_dcopy(DBIG_1024_58 x,DBIG_1024_58 y);
/**	@brief Copy BIG to upper half of DBIG
 *
	@param x DBIG number
	@param y BIG number to be copied
 */
extern void BIG_1024_58_dsucopy(DBIG_1024_58 x,BIG_1024_58 y);
/**	@brief Copy BIG to lower half of DBIG
 *
	@param x DBIG number
	@param y BIG number to be copied
 */
extern void BIG_1024_58_dscopy(DBIG_1024_58 x,BIG_1024_58 y);
/**	@brief Copy lower half of DBIG to a BIG
 *
	@param x BIG number
	@param y DBIG number to be copied
 */
extern void BIG_1024_58_sdcopy(BIG_1024_58 x,DBIG_1024_58 y);
/**	@brief Copy upper half of DBIG to a BIG
 *
	@param x BIG number
	@param y DBIG number to be copied
 */
extern void BIG_1024_58_sducopy(BIG_1024_58 x,DBIG_1024_58 y);
/**	@brief Set BIG to zero
 *
	@param x BIG number to be set to zero
 */
extern void BIG_1024_58_zero(BIG_1024_58 x);
/**	@brief Set DBIG to zero
 *
	@param x DBIG number to be set to zero
 */
extern void BIG_1024_58_dzero(DBIG_1024_58 x);
/**	@brief Set BIG to one (unity)
 *
	@param x BIG number to be set to one.
 */
extern void BIG_1024_58_one(BIG_1024_58 x);
/**	@brief Set BIG to inverse mod 2^256
 *
	@param x BIG number to be inverted
 */
extern void BIG_1024_58_invmod2m(BIG_1024_58 x);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_1024_58_add(BIG_1024_58 x,BIG_1024_58 y,BIG_1024_58 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_1024_58_or(BIG_1024_58 x,BIG_1024_58 y,BIG_1024_58 z);
 ...
 *
	...
	@param i integer
 */
extern void BIG_1024_58_inc(BIG_1024_58 x,int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_1024_58_sub(BIG_1024_58 x,BIG_1024_58 y,BIG_1024_58 z);
/**	@brief Decrement BIG by a small integer - output not normalised
 *
	@param x BIG number to be decremented
	@param i integer
 */
extern void BIG_1024_58_dec(BIG_1024_58 x,int i);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_1024_58_dadd(DBIG_1024_58 x,DBIG_1024_58 y,DBIG_1024_58 z);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_1024_58_dsub(DBIG_1024_58 x,DBIG_1024_58 y,DBIG_1024_58 z);
 ...
 */
extern void BIG_1024_58_imul(BIG_1024_58 x,BIG_1024_58 y,int i);
 ...
 */
extern chunk BIG_1024_58_pmul(BIG_1024_58 x,BIG_1024_58 y,int i);
/**	@brief Divide BIG by 3 - output normalised
 *
	@param x BIG number
	@return Remainder
 */
extern int BIG_1024_58_div3(BIG_1024_58 x);
 ...
 *
	...
	@param i small integer
 */
extern void BIG_1024_58_pxmul(DBIG_1024_58 x,BIG_1024_58 y,int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_1024_58_mul(DBIG_1024_58 x,BIG_1024_58 y,BIG_1024_58 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_1024_58_smul(BIG_1024_58 x,BIG_1024_58 y,BIG_1024_58 z);
 ...
 */
extern void BIG_1024_58_sqr(DBIG_1024_58 x,BIG_1024_58 y);
 ...
 */
extern void BIG_1024_58_monty(BIG_1024_58 a,BIG_1024_58 md,chunk MC,DBIG_1024_58 d);
 ...
 */
extern void BIG_1024_58_shl(BIG_1024_58 x,int s);
 ...
 */
extern int BIG_1024_58_fshl(BIG_1024_58 x,int s);
 ...
 *
	...
	@param s Number of bits to shift
 */
extern void BIG_1024_58_dshl(DBIG_1024_58 x,int s);
/**	@brief Shifts a BIG right by any number of bits - input must be normalised, output normalised
 *
	@param x BIG number to be shifted
	@param s Number of bits to shift
 */
extern void BIG_1024_58_shr(BIG_1024_58 x,int s);
 ...
 *
	...
	@return sign of r
 */
extern int BIG_1024_58_ssn(BIG_1024_58 r,BIG_1024_58 a, BIG_1024_58 m);
 ...
 */
extern int BIG_1024_58_fshr(BIG_1024_58 x,int s);
/**	@brief Shifts a DBIG right by any number of bits - input must be normalised, output normalised
 *
	@param x DBIG number to be shifted
	@param s Number of bits to shift
 */
extern void BIG_1024_58_dshr(DBIG_1024_58 x,int s);
 ...
 */
extern chunk BIG_1024_58_split(BIG_1024_58 x,BIG_1024_58 y,DBIG_1024_58 z,int s);
 ...
 */
extern chunk BIG_1024_58_norm(BIG_1024_58 x);
 ...
 */
extern void BIG_1024_58_dnorm(DBIG_1024_58 x);
 ...
 */
extern int BIG_1024_58_comp(BIG_1024_58 x,BIG_1024_58 y);
 ...
 *
	...
	@return -1 is x<y, 0 if x=y, 1 if x>y
 */
extern int BIG_1024_58_dcomp(DBIG_1024_58 x,DBIG_1024_58 y);
/**	@brief Calculate number of bits in a BIG - output normalised
 *
	@param x BIG number
	@return Number of bits in x
 */
extern int BIG_1024_58_nbits(BIG_1024_58 x);
/**	@brief Calculate number of bits in a DBIG - output normalised
 *
	@param x DBIG number
	@return Number of bits in x
 */
extern int BIG_1024_58_dnbits(DBIG_1024_58 x);
 ...
 *
	...
	@param n The modulus
 */
extern void BIG_1024_58_mod(BIG_1024_58 x,BIG_1024_58 n);
 ...
 *
	...
	@param n The Divisor
 */
extern void BIG_1024_58_sdiv(BIG_1024_58 x,BIG_1024_58 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_1024_58_dmod(BIG_1024_58 x,DBIG_1024_58 y,BIG_1024_58 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_1024_58_ddiv(BIG_1024_58 x,DBIG_1024_58 y,BIG_1024_58 n);
/**	@brief  return parity of BIG, that is the least significant bit
 *
	@param x BIG number
	@return 0 or 1
 */
extern int BIG_1024_58_parity(BIG_1024_58 x);
 ...
 *
	...
	@return 0 or 1
 */
extern int BIG_1024_58_bit(BIG_1024_58 x,int i);
 ...
 */
extern int BIG_1024_58_lastbits(BIG_1024_58 x,int n);
 ...
 */
extern void BIG_1024_58_random(BIG_1024_58 x,csprng *r);
 ...
 *
	...
	@param r A pointer to a Cryptographically Secure Random Number Generator
 */
extern void BIG_1024_58_randomnum(BIG_1024_58 x,BIG_1024_58 n,csprng *r);
 ...
 */
extern void BIG_1024_58_modmul(BIG_1024_58 x,BIG_1024_58 y,BIG_1024_58 z,BIG_1024_58 n);
/**	@brief  Calculate x=y/z mod n
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_1024_58_moddiv(BIG_1024_58 x,BIG_1024_58 y,BIG_1024_58 z,BIG_1024_58 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_1024_58_modsqr(BIG_1024_58 x,BIG_1024_58 y,BIG_1024_58 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_1024_58_modneg(BIG_1024_58 x,BIG_1024_58 y,BIG_1024_58 n);
 ...
 */
extern int BIG_1024_58_jacobi(BIG_1024_58 x,BIG_1024_58 y);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_1024_58_invmodp(BIG_1024_58 x,BIG_1024_58 y,BIG_1024_58 n);
...
*/
extern void BIG_1024_58_mod2m(BIG_1024_58 x,int m);
 ...
 *
	...
	@param m new truncated size
*/
extern void BIG_1024_58_dmod2m(DBIG_1024_58 x,int m);
...
static inline chunk muladd_1024_58(chunk x,chunk y,chunk c,chunk *r)
{
    dchunk prod=(dchunk)x*y+c+*r;
    *r=(chunk)prod&BMASK_1024_58;
    return (chunk)(prod>>BASEBITS_1024_58);
}
...
static inline chunk muladd_1024_58(chunk x,chunk y,chunk c,chunk *r)
{
    ...
    top=x1*y1;
    mid=x0*y1+x1*y0;
    x0=mid&HMASK_1024_58;
    x1=(mid>>HBITS_1024_58);
    bot+=x0<<HBITS_1024_58;
    bot+=*r;
    bot+=c;

    top+=x1;
    carry=bot>>BASEBITS_1024_58;
    bot&=BMASK_1024_58;
    top+=carry;
